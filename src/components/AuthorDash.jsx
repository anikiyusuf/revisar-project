...
<circle cx="5" cy="5" r="4.5" fill="#D3455B" stroke="#F5EEE0"/>
    ...
    <div className="bg-white  w-[1100px] p-4 items-center justify-center">
        <div>
            <p>All Manuscripts</p>
            <p>Manuscripts you submitted for review</p>
        </div>
{/* Table contenth */}
<div className="">
...
23456789</td>
    ...
    <td>Submitted</td>
    <td>12/10/2023</td>
    <td className="flex   text-red-500 w-20 justify-center items-center rounded-md border-2 border-red-500">view</td>
  </tr>
  <tr className="border-b gap-5 border-gray-300 text-left px-8 py-4">
...
23456789</td>
    ...
    <td className="text-[#837F7F]  font-medium  justify-center items-center p-2 w-20 rounded-md bg-[#EEE]">In-Review</td>
    <td>12/10/2023</td>
    <td className="flex   text-red-500 w-20 justify-center items-center rounded-md border-2 border-red-500">view</td>
  </tr>
  <tr className="border-b gap-5 border-gray-300 text-left px-8 py-4">
...
23456789</td>
    ...
    <td className="text-green-600  font-medium  justify-center items-center p-2 rounded-md bg-green-200">Approved</td>
    <td>12/10/2023</td>
    <td className="flex   text-red-500 w-20 justify-center items-center rounded-md border-2 border-red-500">view</td>
  </tr>
...
23456789</td>
    ...
    <td className="text-green-600  font-medium  justify-center items-center p-2 w-20 rounded-md bg-green-200">Approved</td>
    <td>12/10/2023</td>
    <td className="flex   text-red-500 w-20 justify-center items-center rounded-md border-2 border-red-500">view</td>
  </tr>
  <tr>
...
23456789</td>
    ...
    <td className="text-green-600  font-medium   justify-center items-center p-4 rounded-md bg-green-200">Approved</td>
    <td>12/10/2023</td>
    <td className="flex   text-red-500 w-20 justify-center items-center rounded-md border-2 border-red-500">view</td>
  </tr>
</table>
