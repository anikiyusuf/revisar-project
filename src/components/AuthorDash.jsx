...
export default function AuthorDash() {
  return (
    ...
    <div className="AuthorDash">
       <div className="flex   w-[1240px] h-86 p-12 justify-between items-center flex-shrink-0 rounded-8 bg-[#F5EEE0] backdrop-filter backdrop-blur-lg">
...
<circle cx="5" cy="5" r="4.5" fill="#D3455B" stroke="#F5EEE0"/>
    ...
    <section>
      ...
      <div className="flex justify-between items-center">
        ...
        <button className="text-white  inline-flex h-4 px-16 py-6 justify-center items-center gap-8 flex-shrink-0 rounded-md bg-red-500">+ Submit New Mauscript</button>
     </div>
    </section>

    <div className="manuscripts bg-white">
        <div>
            <p>All Manuscripts</p>
...
23456789</td>
    ...
    <td>12/10/2023</td>
    <td> <span>view</span>  <span>Review</span></td>
  </tr>
  <tr>
