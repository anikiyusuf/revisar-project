  ...
  return (
    ...
    <>
     ...
     <form onSubmit="hhdid">
      ...
      <input type="email"  placeholder="Oyakilome@gmail.com" className="flex w-[230px] h-10 p-3.5 flex-col justify-center items-start gap-2 rounded-sm border border-gray-300"/><br/>
